...
ResultEnum YakeiKun::initializeCore()
{
    ...
    while (1)
    {
        ...
        {
            m_Logger.LOG_INFO("[YakeiKun] AUTO Change.\n");
            break;
        }
        ...
        if (50 <= cnt)
        {
            m_Logger.LOG_ERROR("[YakeiKun] AUTO Change Timeout.\n");
            break;
        }
...
void YakeiKun::destroyCore()
{
    ...
    while (1)
    {
        ...
        {
            m_Logger.LOG_INFO("[YakeiKun] MANUAL Change.\n");
            break;
        }
        ...
        if (50 <= cnt)
        {
            m_Logger.LOG_ERROR("[YakeiKun] MANUAL Change Timeout.\n");
            break;
        }
